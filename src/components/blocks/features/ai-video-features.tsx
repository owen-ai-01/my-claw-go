import { Clock, Download, Globe, Link, Sparkles, Zap } from 'lucide-react';
      ...
      <div className="container px-4 md:px-6 mx-auto">
        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4 max-w-6xl mx-auto">
          {features.map((feature, i) => (
            <div
              key={i}
              className={`group rounded-2xl p-6 transition-all duration-300 ${feature.color} dark:bg-card dark:border dark:border-border`}
            >
