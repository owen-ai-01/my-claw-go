        ...
        <div className="grid items-center gap-12 lg:grid-cols-5 lg:gap-24">
          <div className="lg:col-span-2">
            <div className="lg:pr-0">
              <h2 className="text-4xl font-semibold">{t('features2.title')}</h2>
              <p className="mt-6">{t('features2.description')}</p>
            </div>

            <ul className="mt-8 divide-y border-y *:flex *:items-center *:gap-3 *:py-3">
              <li>
                <MailIcon className="size-5" />
                {t('features2.feature-1')}
              </li>
              <li>
                <ZapIcon className="size-5" />
                {t('features2.feature-2')}
              </li>
              <li>
                <ActivityIcon className="size-5" />
                {t('features2.feature-3')}
              </li>
              <li>
                <DraftingCompassIcon className="size-5" />
                {t('features2.feature-4')}
              </li>
            </ul>
          </div>
