      ...
      <div className="border-t py-8">
        <Container className="px-4 flex items-center justify-between gap-x-4">
          ...
          <div className="flex items-center gap-x-4">
            {/* Trust Badges - German Market Optimization */}
            <div className="hidden md:flex items-center gap-2 text-xs text-muted-foreground border px-2 py-1 rounded-md bg-muted/50">
