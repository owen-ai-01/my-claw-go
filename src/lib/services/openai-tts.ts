...
export class OpenAITTSService {
   ...
   */
  async generateTTS(text: string, voice = 'onyx'): Promise<string> {
    console.log(
      `[OpenAI TTS] 🎤 Generating TTS for: "${text.slice(0, 50)}..."`
    );
    console.log(
      `[OpenAI TTS] Voice: ${voice}, Text length: ${text.length} chars`
    );
