...
const DEFAULT_PRICING: Record<string, ModelPricing> = {
  ...
  'openrouter/openai/gpt-5.4': { inputPer1M: 2.5,  outputPer1M: 10.0, cacheReadPer1M: 1.25 },
  'openai/gpt-5.3-codex':      { inputPer1M: 2.0,  outputPer1M: 8.0 },
  'openrouter/openai/gpt-5.3-codex': { inputPer1M: 2.0,  outputPer1M: 8.0 },
  'openai/gpt-5.2':            { inputPer1M: 2.0,  outputPer1M: 8.0 },
  'openrouter/openai/gpt-5.2': { inputPer1M: 2.0,  outputPer1M: 8.0 },
  'openai/gpt-5.1':            { inputPer1M: 2.0,  outputPer1M: 8.0 },
  'openrouter/openai/gpt-5.1': { inputPer1M: 2.0,  outputPer1M: 8.0 },
  'openai/gpt-4o':             { inputPer1M: 2.5,  outputPer1M: 10.0, cacheReadPer1M: 1.25 },
  'openrouter/openai/gpt-4o':  { inputPer1M: 2.5,  outputPer1M: 10.0, cacheReadPer1M: 1.25 },
  ...
  'openrouter/openai/gpt-4.1': { inputPer1M: 2.0,  outputPer1M: 8.0,  cacheReadPer1M: 0.5 },
  ...
  'openrouter/openai/gpt-4.1-nano': { inputPer1M: 0.1,  outputPer1M: 0.4 },
  'openai/o3':                 { inputPer1M: 10.0, outputPer1M: 40.0 },
  'openrouter/openai/o3':      { inputPer1M: 10.0, outputPer1M: 40.0 },
  'openai/o3-mini':            { inputPer1M: 1.1,  outputPer1M: 4.4 },
  'openrouter/openai/o3-mini': { inputPer1M: 1.1,  outputPer1M: 4.4 },
  'openai/o4-mini':            { inputPer1M: 1.1,  outputPer1M: 4.4 },
  'openrouter/openai/o4-mini': { inputPer1M: 1.1,  outputPer1M: 4.4 },
  'openai/gpt-5-mini':         { inputPer1M: 0.25, outputPer1M: 2.0 },
  'openrouter/openai/gpt-5-mini': { inputPer1M: 0.25, outputPer1M: 2.0 },
  'openai/gpt-5-nano':         { inputPer1M: 0.05, outputPer1M: 0.4 },
  'openrouter/openai/gpt-5-nano': { inputPer1M: 0.05, outputPer1M: 0.4 },
  // OpenClaw aliases
  ...
  'anthropic/claude-sonnet-4.6':    { inputPer1M: 3.0, outputPer1M: 15.0, cacheReadPer1M: 0.3 },
  'anthropic/claude-sonnet-4.5':    { inputPer1M: 3.0, outputPer1M: 15.0, cacheReadPer1M: 0.3 },
  ...
  'anthropic/claude-haiku-4.5':     { inputPer1M: 0.8, outputPer1M: 4.0,  cacheReadPer1M: 0.08 },
  ...
  'openrouter/anthropic/claude-sonnet-4.6': { inputPer1M: 3.0, outputPer1M: 15.0, cacheReadPer1M: 0.3 },
  'openrouter/anthropic/claude-opus-4.6':   { inputPer1M: 15.0, outputPer1M: 75.0, cacheReadPer1M: 1.5 },
  'openrouter/anthropic/claude-sonnet-4.5': { inputPer1M: 3.0, outputPer1M: 15.0, cacheReadPer1M: 0.3 },
  'openrouter/anthropic/claude-haiku-4.5':  { inputPer1M: 0.8, outputPer1M: 4.0,  cacheReadPer1M: 0.08 },
  // OpenClaw aliases
  ...
  // ── Google ────────────────────────────────────────────────────────────────
  'google/gemini-3-pro-preview':      { inputPer1M: 1.25, outputPer1M: 10.0 },
  ...
  'openrouter/google/gemini-3-pro-preview':  { inputPer1M: 1.25, outputPer1M: 10.0 },
  'openrouter/google/gemini-2.5-pro':        { inputPer1M: 1.25, outputPer1M: 10.0 },
  'openrouter/google/gemini-2.5-flash-lite': { inputPer1M: 0.1,  outputPer1M: 0.4 },
  'openrouter/google/gemini-2.0-flash-exp':  { inputPer1M: 0.25, outputPer1M: 1.2 },
  'openrouter/google/gemini-2.0-flash-001':  { inputPer1M: 0.25, outputPer1M: 1.2 },

  // ── OpenRouter / DeepSeek / GLM / MiniMax / Kimi ─────────────────────────
  ...
  'openrouter/deepseek/deepseek-v3.1':  { inputPer1M: 0.27, outputPer1M: 1.1 },
  ...
  'deepseek/deepseek-v3.1':             { inputPer1M: 0.27, outputPer1M: 1.1 },
  ...
  // GLM / Z.ai — conservative defaults, can be overridden via env JSON later
  'openrouter/z-ai/glm-5':              { inputPer1M: 0.25, outputPer1M: 1.2 },
  'z-ai/glm-5':                         { inputPer1M: 0.25, outputPer1M: 1.2 },
  'openrouter/z-ai/glm-4.7':            { inputPer1M: 0.25, outputPer1M: 1.2 },
  'z-ai/glm-4.7':                       { inputPer1M: 0.25, outputPer1M: 1.2 },
  'openrouter/z-ai/glm-4.7-flash':      { inputPer1M: 0.25, outputPer1M: 1.2 },
  'z-ai/glm-4.7-flash':                 { inputPer1M: 0.25, outputPer1M: 1.2 },
  'openrouter/z-ai/glm-4.6':            { inputPer1M: 0.25, outputPer1M: 1.2 },
  'z-ai/glm-4.6':                       { inputPer1M: 0.25, outputPer1M: 1.2 },
  'openrouter/z-ai/glm-4.6v':           { inputPer1M: 0.25, outputPer1M: 1.2 },
  'z-ai/glm-4.6v':                      { inputPer1M: 0.25, outputPer1M: 1.2 },
  // Kimi / Moonshot AI — conservative defaults, can be overridden via env JSON later
  'openrouter/moonshotai/kimi-k2.5':    { inputPer1M: 0.25, outputPer1M: 1.2 },
  'moonshotai/kimi-k2.5':               { inputPer1M: 0.25, outputPer1M: 1.2 },
  'openrouter/moonshotai/kimi-k2-thinking': { inputPer1M: 0.25, outputPer1M: 1.2 },
  'moonshotai/kimi-k2-thinking':        { inputPer1M: 0.25, outputPer1M: 1.2 },
  'openrouter/moonshotai/kimi-k2':      { inputPer1M: 0.25, outputPer1M: 1.2 },
  'moonshotai/kimi-k2':                 { inputPer1M: 0.25, outputPer1M: 1.2 },
  // OpenRouter auto route — kept in billing for safety, but excluded from selectable models
