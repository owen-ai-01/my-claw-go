                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div>
                        ...
                        <ul className="space-y-1">
                          {(state.analysis.keyFeatures || []).map(
                            (feature, i) => (
                              <li
                                key={i}
                ...
                <Card>
                  ...
                  <CardContent>
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      {(state.assets?.scenes || state.storyboard?.scenes)?.map(
                        (scene: Scene) => (
                          <div
                            key={scene.id}
                                ...
                                <img
                                  ...
                                  onError={(e) => {
                                    ...
                                    (e.target as HTMLImageElement).src =
                                      `https://placehold.co/1920x1080/png?text=Image+${scene.sceneNumber}`;
                                  }}
                                />
                              ) : (
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div className="p-3 bg-amber-500/10 border border-amber-500/20 rounded-lg">
                      <p className="text-xs text-amber-700 dark:text-amber-400">
                        ⚠️ <strong>Note:</strong> Sandbox videos are temporary
                        and will be deleted after 24 hours. Download or save
                        your video now!
                      </p>
                    </div>
                  </CardContent>
