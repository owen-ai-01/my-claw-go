        ...
        <main className="mx-auto max-w-6xl px-6 py-14 md:py-20">
          <section className="rounded-3xl border border-border bg-card p-8 shadow-xl md:p-12">
            ...
            <p className="mx-auto mt-5 max-w-4xl text-center text-base text-muted-foreground md:text-lg">
              ...
              friction. You do not need to learn server operations, buy
              infrastructure, or debug credentials before seeing value. You get
              a private workspace that feels like your own OpenClaw, ready to
              use from day one.
            </p>
          ...
          <section className="mt-14 space-y-5 rounded-2xl border border-border bg-card p-8">
            ...
            <p className="text-sm leading-7 text-muted-foreground">
              My Claw Go is a hosted OpenClaw experience for people who want AI
              execution power without infrastructure complexity. In a
              traditional setup, users must choose a VPS provider, configure
              system packages, manage model keys, and keep services running.
              That path works for technical users but blocks most real operators
              who just want to ship outcomes. My OpenClaw removes that friction.
              Instead of spending days on setup, users can focus on actual
              tasks: generating outputs, running workflows, and building
              repeatable operations. This product exists to bridge that gap
              between capability and usability.
            </p>
            <p className="text-sm leading-7 text-muted-foreground">
              The core promise is simple: your own workspace, your own context,
              your own continuity. When you come back, your state is still
              there. You are not sharing a generic chatbot session. You are
              working inside your own My Claw Go environment. That means your
              prompts, process, and knowledge can evolve over time, and your
              productivity compounds. This is especially important for founders,
              marketers, and operators who run recurring systems and need
              consistency, not one-off answers.
            </p>
          </section>
          ...
          <section
            id="how-to-use"
            className="mt-14 space-y-6 rounded-2xl border border-border bg-card p-8"
          >
            <h2 className="text-2xl font-semibold">
              🧭 Tutorial & How It Works
            </h2>
            <p className="text-sm leading-7 text-muted-foreground">
              You can think of My Claw Go as a practical execution workspace
              that is ready from the moment you subscribe. Step one is creating
              your account and selecting the right plan. Step two is opening
              your workspace and entering your first instruction. Step three is
              iterating your workflow with persistent context. Because setup
              burden is removed, the time from sign-up to first useful output is
              dramatically shorter than self-hosted alternatives. The product is
              intentionally designed to help non-technical users produce results
            ...
            <div className="grid gap-4 md:grid-cols-3">
              <article className="rounded-xl border border-border bg-muted/50 p-5">
                ...
                <p className="mt-2 text-xs leading-6 text-muted-foreground">
                  Sign up in minutes, choose Pro/Premium/Ultra, and unlock your
                  private My Claw Go workspace instantly.
                </p>
              </article>
              <article className="rounded-xl border border-border bg-muted/50 p-5">
                <div className="text-2xl">⚙️</div>
                <h3 className="mt-3 text-sm font-semibold">
                  Step 2: Open your workspace and give your first instruction
                </h3>
                <p className="mt-2 text-xs leading-6 text-muted-foreground">
                  Use natural language to run tasks. Your context and operations
                  stay inside your own isolated workspace.
                </p>
              </article>
              <article className="rounded-xl border border-border bg-muted/50 p-5">
                <div className="text-2xl">📊</div>
                <h3 className="mt-3 text-sm font-semibold">
                  Step 3: Scale usage as your workload grows
                </h3>
                <p className="mt-2 text-xs leading-6 text-muted-foreground">
                  Start lean, then move to higher-credit plans when your weekly
                  execution volume increases.
                </p>
              </article>
            </div>
            <p className="text-sm leading-7 text-muted-foreground">
              For teams and advanced users, the same flow scales naturally. You
              can begin with lightweight usage and move to larger credit plans
              when demand grows. This makes My Claw Go a practical bridge
              between early experimentation and production-level usage. Instead
              of rebuilding your stack later, you continue inside the same
              product and expand with better capacity.
            </p>
          </section>
          ...
          <section id="choose-plan" className="mt-14 space-y-6">
            ...
            <p className="max-w-4xl text-sm leading-7 text-muted-foreground">
              Start with Pro if you are validating your workflow. Choose Premium
              if you run regular weekly operations and want more headroom.
              Choose Ultra if you depend on high-volume execution and need the
              highest credit allowance. All plans are built around the same
              principle: your private My Claw Go workspace, ready without
          ...
          <section className="mt-10 rounded-2xl border border-border bg-card p-8 text-center">
            <h2 className="text-2xl font-semibold">
              Ready to start your own OpenClaw?
            </h2>
            <p className="mx-auto mt-3 max-w-3xl text-sm leading-7 text-muted-foreground">
              Skip infrastructure work and start executing right away with your
              private My Claw Go workspace.
            </p>
          ...
          <section className="mt-10 space-y-6 rounded-2xl border border-border bg-card p-8">
            <h2 className="text-2xl font-semibold">
              OpenClaw highlights in My Claw Go
            </h2>
            <p className="text-sm leading-7 text-muted-foreground">
              My Claw Go gives you a <strong>hosted OpenClaw</strong> experience
              with a clear product flow: sign up, choose a plan, and use your
              own OpenClaw workspace instantly. This is designed for users who
              want <strong>OpenClaw without VPS</strong> and
              <strong> OpenClaw without setup</strong> while still keeping a
              private, consistent workspace.
            </p>
            ...
            <div className="grid gap-4 md:grid-cols-3">
              <article className="rounded-xl border border-border bg-muted/40 p-5">
                <div className="text-2xl">🚀</div>
                <h3 className="mt-3 text-sm font-semibold">
                  Hosted OpenClaw, ready after payment
                </h3>
                <p className="mt-2 text-xs leading-6 text-muted-foreground">
                  Start with a managed OpenClaw runtime instead of provisioning
                  servers and dependencies yourself.
                </p>
              </article>
              ...
              <article className="rounded-xl border border-border bg-muted/40 p-5">
                <div className="text-2xl">🧩</div>
                <h3 className="mt-3 text-sm font-semibold">
                  OpenClaw without setup complexity
                </h3>
                <p className="mt-2 text-xs leading-6 text-muted-foreground">
                  No VPS procurement, no environment troubleshooting, and no
                  long setup checklist before you can use OpenClaw.
                </p>
              </article>
              ...
              <article className="rounded-xl border border-border bg-muted/40 p-5">
                <div className="text-2xl">💼</div>
                <h3 className="mt-3 text-sm font-semibold">
                  OpenClaw as a service for non-technical users
                </h3>
                <p className="mt-2 text-xs leading-6 text-muted-foreground">
                  My Claw Go is built for users who want OpenClaw outcomes, not
